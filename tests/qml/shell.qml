...
ShellRoot {
  ...
  function runChecks() {
    ...
    if (widget) {
      ...
      widget.showCostSettings()
      assertEqual(widget.viewMode, "cost-settings", "navigation does not override cost settings")
      widget.leaveSettings()
      assertEqual(widget.viewMode, "costs", "leaving settings restores Costs")
      widget.showLimits()
